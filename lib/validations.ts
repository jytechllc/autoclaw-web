...
// ── API Keys (BYOK) ──
const allowedService = z.enum(["brevo", "sendgrid", "apollo", "apify", "hunter", "snov_api_id", "snov_api_secret", "tavily", "openai", "anthropic", "google", "alibaba", "cerebras", "vercel", "clawhub", "xpilot", "twitter_api_key", "twitter_api_secret", "twitter_access_token", "twitter_access_token_secret", "tiktok_client_key", "tiktok_client_secret", "blob_token", "worker_url", "worker_secret"]);
