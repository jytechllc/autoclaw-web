...
const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    version: "1.4.0",
    title: {
      en: "WeChat Pay, TikTok & Agent Improvements",
      zh: "微信支付、TikTok 与智能体优化",
      "zh-TW": "微信支付、TikTok 與智能體優化",
      fr: "WeChat Pay, TikTok et améliorations des agents",
      ko: "WeChat Pay, TikTok 및 에이전트 개선",
    },
    items: {
      en: [
        "WeChat Pay integration — Chinese users on yeoso.com can pay via WeChat QR code for Growth and Scale plans.",
        "TikTok content posting — Connect your TikTok account and publish videos directly from AutoClaw.",
        "Chat widget improvements — Better error handling and model selection in AI chat.",
        "Agent execution fixes — Improved task execution reliability and error reporting.",
        "GitHub Actions — Automated branch sync workflow for continuous deployment.",
      ],
      zh: [
        "微信支付集成 — yeoso.com 上的中文用户可通过微信二维码支付 Growth 和 Scale 计划。",
        "TikTok 内容发布 — 连接 TikTok 账户，直接从 AutoClaw 发布视频。",
        "对话组件优化 — AI 对话中更好的错误处理和模型选择。",
        "智能体执行修复 — 提升任务执行可靠性和错误报告。",
        "GitHub Actions — 自动化分支同步工作流，用于持续部署。",
      ],
      "zh-TW": [
        "微信支付整合 — yeoso.com 上的中文用戶可透過微信 QR 碼支付。",
        "TikTok 內容發佈 — 連接 TikTok 帳號，直接從 AutoClaw 發佈影片。",
        "對話元件優化 — AI 對話中更好的錯誤處理和模型選擇。",
        "智能體執行修復 — 提升任務執行可靠性和錯誤報告。",
        "GitHub Actions — 自動化分支同步工作流。",
      ],
      fr: [
        "Intégration WeChat Pay — Les utilisateurs chinois sur yeoso.com peuvent payer via QR code WeChat.",
        "Publication TikTok — Connectez votre compte TikTok et publiez directement depuis AutoClaw.",
        "Améliorations du chat — Meilleure gestion des erreurs et sélection de modèle.",
        "Corrections d'exécution des agents — Fiabilité et rapport d'erreurs améliorés.",
        "GitHub Actions — Workflow de synchronisation automatique des branches.",
      ],
      ko: [
        "WeChat Pay 통합 — yeoso.com에서 중국 사용자가 WeChat QR 코드로 결제 가능.",
        "TikTok 콘텐츠 게시 — TikTok 계정 연결 후 AutoClaw에서 직접 비디오 게시.",
        "채팅 위젯 개선 — AI 채팅의 오류 처리 및 모델 선택 개선.",
        "에이전트 실행 수정 — 작업 실행 안정성 및 오류 보고 개선.",
        "GitHub Actions — 지속적 배포를 위한 자동 브랜치 동기화.",
      ],
    },
  },
  {
