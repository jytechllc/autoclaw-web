              ...
              <div key={uc.slug} className={`bg-white rounded-xl border overflow-hidden ${isFeatured ? "border-red-200 shadow-sm" : "border-gray-200"}`}>
                ...
                {isExpanded && (
                  <div className="p-6">
                    ...
                    {/* Markdown content */}
                    <div className="prose prose-sm max-w-none prose-headings:text-gray-900 prose-h2:text-lg prose-h2:mt-6 prose-h2:mb-3 prose-h3:text-base prose-p:text-gray-600 prose-li:text-gray-600 prose-strong:text-gray-800">
