...
export const metadata = {
  title: "Terms of Service – AutoClaw",
};
...
export default async function TermsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const sections = [
    ...
    { title: t.dataCollectionTitle, content: t.dataCollectionContent },
    { title: t.dataConfidentialityTitle, content: t.dataConfidentialityContent },
    { title: t.intellectualPropertyTitle, content: t.intellectualPropertyContent },
    { title: t.prohibitedTitle, content: t.prohibitedContent },
